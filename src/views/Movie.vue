            ...
            <el-row v-for="subList in movieList" type="flex" justify="center" style="margin-top:20px;">
                <el-col :span="4">
                    ...
                    <div>
                        ...
                        &nbsp; &nbsp;
                        <span class="scroe-span">{{subList[0].score}}</span>
                    </div>
                </el-col>
                <el-col :span="4">
                    ...
                    <div>
                        ...
                        &nbsp; &nbsp;
                        <span class="scroe-span">{{subList[1].score}}</span>
                    </div>
                </el-col>
                <el-col :span="4">
                    ...
                    <div>
                        ...
                        &nbsp; &nbsp;
                        <span class="scroe-span">{{subList[2].score}}</span>
                    </div>
                </el-col>
                <el-col :span="4">
                    ...
                    <div>
                        ...
                        &nbsp; &nbsp;
                        <span class="scroe-span">{{subList[3].score}}</span>
                    </div>
                </el-col>
                <el-col :span="4">
                    ...
                    <div>
                        ...
                        &nbsp; &nbsp;
                        <span class="scroe-span">{{subList[4].score}}</span>
                    </div>
                </el-col>
            </el-row>
        </el-row>
